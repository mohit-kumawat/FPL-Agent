...
| template (most-owned XI) | 495 | crowd benchmark |
...
- per-GW (template): [56, 50, 36, 54, 31, 69, 37, 36, 74, 52]
...
| template (most-owned XI) | 548 | crowd benchmark |
...
- per-GW (template): [78, 80, 70, 42, 53, 60, 45, 24, 62, 34]
...
|---|---|---|---|---|---|
| 2023-24 (clean) | +15.4 | 19.6 | [+4.3, +27.2] | [+43, +272] | 8/10 |
| 2024-25 (tuned-on) | +4.4 | 16.2 | [-4.9, +13.9] | [-49, +139] | 6/10 |
...
features with player and team identity replaced by per-GW salted codes, so
recall is impossible. The **named** arm sees names, and recall was
